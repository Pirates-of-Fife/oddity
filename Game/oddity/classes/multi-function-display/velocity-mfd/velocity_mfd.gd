...
func _process(delta: float) -> void:	
	if current_max_velocity == 0:
		vertical_velocity_down_progress_bar.max_value = max_velocity
		vertical_velocity_up_progress_bar.max_value = max_velocity
		lateral_velocity_left_progress_bar.max_value = max_velocity
		lateral_velocity_right_progress_bar.max_value = max_velocity
		forwards_backwards_velocity_progress_bar.max_value = max_velocity
